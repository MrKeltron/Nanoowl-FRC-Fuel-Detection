...
# Camera settings
# 0 = first USB webcam
USE_CSI_CAMERA = True              # Set True on Jetson for CSI camera
CAMERA_WIDTH = 416
CAMERA_HEIGHT = 416
CAMERA_FPS = 30
CSI_SENSOR_ID = 0       # 0 = wide angle, 1 = zoom

CSI_PIPELINE = (
    f"nvarguscamerasrc sensor-id={CSI_SENSOR_ID} ! "
    "video/x-raw(memory:NVMM), width=1280, height=720, framerate+35/1 ! "
...
def get_camera():
    ...
    # CAP_DSHOW is Windows only - auto detect platform
    import platform
